...
///
/// In Plait 0.9, `@Component` calls also require construction helpers generated by
/// [`component!`](crate::component). Implementing this trait alone still supports
/// direct rendering, but no longer enables `@` construction of a handwritten
/// struct. Use `component!` to retain `@` syntax, or construct and render your
/// handwritten component directly. See the macro documentation for migration examples.
///
